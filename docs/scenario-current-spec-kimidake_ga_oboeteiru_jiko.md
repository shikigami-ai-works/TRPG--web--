...
5. `docs/NEXT_CHAT_HANDOFF_2026-05-30_scene7_return_fire.md`: 直近作業の詳細な引き継ぎ。
6. `docs/NEXT_CHAT_HANDOFF_2026-05-30.md`、`docs/NEXT_CHAT_HANDOFF_2026-05-30_ritual_order.md`、`docs/scenario-writing-*.md`: 履歴として参照する。現行仕様と食い違う場合は、このファイル、YAML、現行本文を優先する。
...
- 変更後は少なくとも `npm run validate:scenarios` と `npm run test` を通す。
